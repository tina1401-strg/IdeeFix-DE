...
from utils.constants import get_best_gpu, SEP, RANDOM_SEED
...
def solve_model_id(model_id):
    if model_id == 'gbert-large':
        return 'deepset/gbert-large'
    elif model_id == 'gbert-base':
        return 'deepset/gbert-base'
    else:
        return model_id
...
def get_parser():
    ...
    parser.add_argument('--model_id', default='gbert-large', choices=["gbert-large", "gbert-base"])
